...
class YemeklerCevap{
  ...
  factory YemeklerCevap.fromJson(Map<String,dynamic> json){
    ...
    List<Yemekler> yemeklerListesi=jsonArray.map((jsonArrayNesnesi)
    => Yemekler.fromJson(jsonArrayNesnesi)).toList();
    return YemeklerCevap(yemeklerListesi: yemeklerListesi,
